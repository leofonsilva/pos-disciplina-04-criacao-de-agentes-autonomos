...
# Verifica se o encoding atual não é UTF-8
if sys.stdout.encoding and sys.stdout.encoding.lower() != "utf-8":
    # Recria stdout e stderr com encoding UTF-8 para evitar erros com caracteres especiais
    sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8", errors="replace")
    sys.stderr = io.TextIOWrapper(sys.stderr.buffer, encoding="utf-8", errors="replace")

# Importa as funções principais do módulo ciclo
from ciclo import rodar, replay, exibir_rastreamento
from validador import validar  # Importa função de validação de contratos
from benchmark import rodar_benchmark, gerar_relatorio_comparativo  # Importa funções de benchmark
...
def _gerar_relatorio_md(dados_trace: dict, dados_analise: dict) -> str:
    ...
    # Resultados específicos do analyzer
...
def main():
    ...
    subparsers = parser.add_subparsers(dest="comando")  # Subcomandos (rodar, validar, etc.)
    ...
    # Subcomando: comparar (roda benchmark das 3 arquiteturas e gera relatório)
