...
import json  # Para manipular JSON (argumentos e respostas)
...
# Constante para consumo de tokens zero (fallback)
...
def _chamar_llm_ferramenta(prompt_sistema: str, prompt_usuario: str, campos_saida: dict) -> tuple:
    ...
    from openai import OpenAI  # Importa apenas se necessário

    cliente = OpenAI(api_key=chave_api)
    
    # Faz a chamada à LLM pedindo resposta em JSON
    resposta = cliente.chat.completions.create(
        model="gpt-4o-mini",  # Modelo pequeno e rápido
